...
@ccclass('ConfigAdInternal')
export class ConfigAdInternal extends ConfigInternalBase {

    public static SOURCE_TYPE_SPLASH = 0;
    public static SOURCE_TYPE_BANNER = 1;
    public static SOURCE_TYPE_INSERT = 2;
    public static SOURCE_TYPE_SPLASH_INSERT = 3;
    public static SOURCE_TYPE_NATIVE = 4;
    public static SOURCE_TYPE_VIDEO = 5;
    public static SOURCE_TYPE_INSERT_VIDEO = 6;
    ...
    GetAdSource(type) {
        ...
        // switch (type) {
        //     case ConfigAdInternal.SOURCE_TYPE_SPLASH:
        //         src = AdConfigParser.adSourceSplash;

        //         break;
        //     case ConfigAdInternal.SOURCE_TYPE_BANNER:
        //         src = AdConfigParser.adSourceBanner;

        //         break;
        //     case ConfigAdInternal.SOURCE_TYPE_INSERT:
        //         src = AdConfigParser.adSourceInsert;
        //         break;
        //     case ConfigAdInternal.SOURCE_TYPE_SPLASH_INSERT:
        //         src = AdConfigParser.adSourceSplashInsert;
        //         break;
        //     case ConfigAdInternal.SOURCE_TYPE_NATIVE:
        //         src = AdConfigParser.adSourceNative;
        //         break;
        //     case ConfigAdInternal.SOURCE_TYPE_VIDEO:
        ...
        if (info != null) {
            switch (type) {
                ...
                case ConfigAdInternal.SOURCE_TYPE_VIDEO:
                    ret = info.key_video;
                    break;
                case ConfigAdInternal.SOURCE_TYPE_INSERT_VIDEO:
